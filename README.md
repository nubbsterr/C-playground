# C-playground
A collection of random stuff I've done with C (because we love C)!

Including but not limited to:
* TCP communication over sockets (found under ./programming/C/gek_challenge)[./programming/C/gek_challenge]
* XOR encryption magic (found under ./programming/C/xor_encryption_fun)[./programming/C/xor_encryption_fun]
